...
type UserServiceClient interface {
	...
	GetUser(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*ListUserResponse, error)
}
...
func (c *userServiceClient) GetUser(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*ListUserResponse, error) {
...
type UserServiceServer interface {
	...
	GetUser(context.Context, *ListUserRequest) (*ListUserResponse, error)
...
func (UnimplementedUserServiceServer) GetUser(context.Context, *ListUserRequest) (*ListUserResponse, error) {
...
func _UserService_GetUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUser(ctx, req.(*ListUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
